/**
 * @file
 * This file is modified from the useRainbow helper at
 * https://github.com/queerjs/website/blob/master/src/helpers/useRainbow.js
 */
import { toPastel } from "./colours";

// helpers for representing flags that have different sized stripes
const sizedStripe = (colour, size) => {
  return {
    colour,
    size,
  };
...
const pastelizeStripe = ({ colour, size }) => {
  return {
    colour: toPastel(colour),
    size,
  };
};
...
export const aceStripes = ["#000000", "#A3A3A3", "#DDD", "#810082"].map(
  toSizedPastelStrip
);
...
const lazyBiBoy = [sizedStripe("#D9006F", 2), "#744D98"].map(
  toSizedPastelStrip
);
const lazyBiGirl = ["#744D98", sizedStripe("#0033AB", 2)].map(
  toSizedPastelStrip
);

export const biStripes = [
  sizedStripe("#D9006F", 2),
  "#744D98",
  sizedStripe("#0033AB", 2),
].map(toSizedPastelStrip);
export const fluidStripes = [
  "#FE75A4",
  "#FFFFFF",
  "#A90FC0",
  "#000000",
...
const genderqueerStripes = ["#B999DD", "#FEFEFE", "#6A8C3A"].map(
  toSizedPastelStrip
);
...
const polysexualStripes = ["#F71BB9", "#08D569", "#1C91F6"].map(
  toSizedPastelStrip
);
export const transStripes = [
  "#55CDFC",
  "#F7A8B8",
  "#DDD",
  "#F7A8B8",
...
export const allStripes = [
  ...
  },
  {
    stripes: aceStripes,
    name: "Asexual",
    wiki: "https://en.wikipedia.org/wiki/Asexuality",
  },
  {
    stripes: agenderStripes,
    name: "Agender",
    wiki: "https://en.wikipedia.org/wiki/Agender",
  },
  {
  ...
  },
  {
    stripes: biStripes,
    name: "Bisexual",
    wiki: "https://en.wikipedia.org/wiki/Bisexuality",
  },
  {
