...
export default function () {
  return (
    <>
      ...
      <p>
        Organisers enforce this code throughout the event. We expect cooperation
      ...
      <p>
        At our meetup, we are dedicated to providing a harassment-free meetup
      ...
      <p>
        We do not tolerate harassment of meetup participants in any form. We ask
        that all attendees are mindful of their surroundings and of their fellow
        participants.
      </p>
      ...
      <p>
        If a participant engages in harassing behaviour, the meetup organisers
        may take any action they deem appropriate, including warning the
        offender or expulsion from the meetup with no refund.
      </p>

      <p>
        If you are subject to or witness unacceptable behavior, or have any
        other concerns, please notify an organiser as soon as possible.
      </p>
      ...
      <p>
        Meetup organisers are happy to help participants and assist people
